...
public class Financing {
	...
	public void setTotalAmount(Double totalAmount) {
		validateFinancing (totalAmount, this.income, this.months);
		this.totalAmount = totalAmount;
	}
	...
	public void setIncome(Double income) {
		validateFinancing (this.totalAmount, income, this.months);
		this.income = income;
	}
	...
	public void setMonths(Integer months) {
		validateFinancing (this.totalAmount, this.income, months);
		this.months = months;
	}
}
